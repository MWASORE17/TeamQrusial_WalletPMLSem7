package com.wenlong.qianbao.session;
...
public class SessionManager {
    ...
    * @param: User
    */
    public void createsession(AuthModel user) {
    ...
    */
    public AuthModel getuserloggedin() {
        return new Gson().fromJson(sharedpreferences.getString(USER_DATA, ""), AuthModel.class);
    }
